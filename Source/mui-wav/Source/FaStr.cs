...
namespace mui_smf
{
	static public class FaStr
	{
		...
		public const string Automobile = Car;
		...
		public const string Bank = University;

		public const string BarChart = "";

		public const string BarChartO = BarChart;
		...
		public const string Battery3 = BatteryThreeQuarters;
		...
		public const string Chain = Link;
		...
		public const string Close = Times;
		...
		public const string Copy = FilesO;
		...
		public const string Dashboard = Tachometer;

		public const string Dashcube = "";

		public const string Database = "";

		public const string Dedent = Outdent;
		...
		public const string Edit = PencilSquareO;
		...
		public const string FacebookF = Facebook;
		...
		public const string FileMovieO = FileVideoO;

		public const string FileO = "";

		public const string FilePdfO = "";

		public const string FilePhotoO = FileImageO;

		public const string FilePictureO = FileImageO;

		public const string FilePowerpointO = "";

		public const string FileSoundO = FileAudioO;
		...
		public const string FileZipO = FileArchiveO;
		...
		public const string Flash = Bolt;
		...
		public const string Ge = Empire;

		public const string Gear = Cog;

		public const string Gears = Cogs;
		...
		public const string Gittip = Gratipay;
		...
		public const string HandGrabO = HandRockO;
		...
		public const string HandStopO = HandPaperO;
		...
		public const string Hotel = Bed;

		public const string Hourglass = "";

		public const string Hourglass1 = HourglassStart;

		public const string Hourglass2 = HourglassHalf;

		public const string Hourglass3 = HourglassEnd;
		...
		public const string Image = PictureO;
		...
		public const string Institution = University;

		public const string InternetExplorer = "";

		public const string Intersex = Transgender;
		...
		public const string Legal = Gavel;
		...
		public const string LifeBouy = LifeRing;

		public const string LifeBuoy = LifeRing;

		public const string LifeRing = "";

		public const string LifeSaver = LifeRing;
		...
		public const string MailForward = Share;

		public const string MailReply = Reply;

		public const string MailReplyAll = ReplyAll;
		...
		public const string MortarBoard = GraduationCap;
		...
		public const string Navicon = Bars;
		...
		public const string Paste = Clipboard;
		...
		public const string Photo = PictureO;
		...
		public const string Remove = Times;

		public const string Renren = "";

		public const string Reorder = Bars;
		...
		public const string Rouble = Rub;
		...
		public const string Ruble = Rub;

		public const string Rupee = Inr;

		public const string Safari = "";

		public const string Save = FloppyO;
		...
		public const string Send = PaperPlane;

		public const string SendO = PaperPlaneO;
		...
		public const string Sheqel = Ils;
		...
		public const string SoccerBallO = FutbolO;
		...
		public const string SortDown = SortDesc;

		public const string SortNumericAsc = "";

		public const string SortNumericDesc = "";

		public const string SortUp = SortAsc;
		...
		public const string StarHalfEmpty = StarHalfO;

		public const string StarHalfFull = StarHalfO;
		...
		public const string Support = LifeRing;
		...
		public const string ToggleDown = CaretSquareODown;

		public const string ToggleLeft = CaretSquareOLeft;

		public const string ToggleOff = "";

		public const string ToggleOn = "";

		public const string ToggleRight = CaretSquareORight;

		public const string ToggleUp = CaretSquareOUp;
		...
		public const string Unlink = ChainBroken;

		public const string Unlock = "";

		public const string UnlockAlt = "";

		public const string Unsorted = Sort;
		...
		public const string Warning = ExclamationTriangle;

		public const string Wechat = Weixin;
		...
		public const string YCombinatorSquare = HackerNews;

		public const string Yahoo = "";

		public const string Yc = YCombinator;

		public const string YcSquare = HackerNews;
