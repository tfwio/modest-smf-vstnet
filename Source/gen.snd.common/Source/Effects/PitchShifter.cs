/* oio * 7/31/2015 * Time: 3:30 AM
 */

namespace gen.snd.Effects
{
	/****************************************************************************
*
* NAME: PitchShift.cs
        ...
        public static void PitchShift(float pitchShift, long numSampsToProcess, long fftFrameSize, long osamp, float sampleRate, float[] indata)
        {
            ...
            for (i = 0; i < numSampsToProcess; i++)
            {
                ...
                if (gRover >= fftFrameSize)
                {
                    ...
                    for (int zero = 0; zero < fftFrameSize; zero++) { gSynMagn[zero] = 0; gSynFreq[zero] = 0; }
