...
namespace gen.snd
{
  static class MidiHelper
  {
    ...
    public static readonly bool[] IsIvory = new bool[12] { true, false, true, false, true, true, false, true, false, true, false, true };
    public static readonly string[] keys = new string[12]{ "C ", "C#",  "D ", "D#",  "E ", "F ", "F#",  "G ", "G#",  "A ", "A#",  "B " };
  }
}
