...
namespace modest100.Forms
{
  ...
  public class MidiPianoView : MidiControlBase, IUi, IUiOffset, INotifyPropertyChanged
  {
    ...
    public Padding Gutter {
      get { return new Padding(Ren.ui_view_settings.ClientPadding.Left, Ren.ui_view_settings.ClientPadding.Top, Ren.ui_view_settings.ClientPadding.Right,Ren.ui_view_settings.ClientPadding.Bottom); /**/ }
      set { Ren.ui_view_settings.ClientPadding = value; Invalidate(); }
    }
    ...
    FloatPoint HoverPoint { get { return new FloatPoint( Math.Floor((double)ClientMouse.X / Ren.ui_view_settings.NodeWidth), OffsetY-Math.Floor((double)ClientMouse.Y / Ren.ui_view_settings.NodeHeight) ); } }
    ...
    public MidiPianoView() : base()
    {
      ...
      try {
        MidiPianoViewRenderer.ui_view_settings = new MidiPianoViewSettings(this);
      } catch {
      }
      
      int gt = MidiPianoViewRenderer.ui_view_settings.ClientPadding.Top;
