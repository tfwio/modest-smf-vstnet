...
{
  public class MuiControlContainer : Form, IMui
  {
...
//      InitializeComponent();
      ...
      Widgets = new Widget[] {
        ...
        new ButtonWidget(this) {
          Padding = DPadding,
          Bounds = new FloatRect(i, 10, 100, 24),
          Text = "ASOME"
        },
        new ButtonWidget(this) {
          Padding = DPadding,
          Bounds = new FloatRect(i = i + 100, 10, 50, 24),
          Text = "➤"
        },
        new ButtonWidget(this) {
          Padding = DPadding,
          Bounds = new FloatRect(i = i + 50, 10, 100, 24),
          Text = "CSOME"
        },
